                  ...
                  try{
                    ...
                    if($contar > 0){
                      while($show = $resultSel->FETCH(PDO::FETCH_OBJ)){
                        ...
                        $telefoneCont = $show -> telefoneContato;
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="telefone" type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $telefoneCont; ?>">
                  </div>
                  <div class="form-group">
                    ...
                    if(!empty($_FILES['foto']['name'])){
                      ...
                      if(in_array($extensao,$formatP)){
                        ...
                        if(move_uploaded_file($temporario, $pasta.$novoNome)){
                          $cadastro="UPDATE tbContato SET nomeContato=:nome, telefoneContato=:telefone, emailContato=:email, fotoContato=:foto WHERE idContato=:id";                   
                          try{
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-body p-0" style="text-align: center;">
                <img src="img/contato/<?php echo $fotoCont;?>" alt="" style="width: 200px; border-radius: 100%; margin-top: 50px;">
                <h1><?php echo $nomeCont;?></h1>
                <h2><?php echo $telefoneCont;?></h2>
                <h3 style="margin-bottom: 50px;"><?php echo $emailCont;?></h3>
              </div>
              <!-- /.card-body -->
            </div>
          </div>
