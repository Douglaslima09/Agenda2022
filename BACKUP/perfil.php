  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Douglas Lima</a>
        </div>
      </div>
              ...
              <form method="post" action="">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input name="nome" type="text" class="form-control" id="exampleInputPassword1" placeholder="Digite o nome de contato..." name="nome">
                  </div>
                  <div class="form-group">
              ...
              <?php
                  ...
                  if(isset($_POST['btnCContato'])){
                    ...
                    try{
                      ...
                      echo "<strong>ERRO DE CADASTRO PDO = </strong>".$erro-getMesage();
                    }
                  }
              ?>
            </div>
